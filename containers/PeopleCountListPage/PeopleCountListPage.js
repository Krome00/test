...
// class PeopleCountListPage extends Component {

// 	componentDidMount(){
// 		this.props.getPeopleCountListPage();
// 	}
...
// 	renderTable() {
// 		const { people_counts } = this.props.peopleCountListPageProps || {};
// 		let data = [];

// 		people_counts && people_counts.length && people_counts.map( people_counts => {
// 			const { _id: id, user_id, location_id, door_id, time, people_counts_type, result } = people_counts;
// 			data.push({
// 				id,
// 				name: user_id.name,
...
// 				people_counts_type: LabelHelper.people_counts_labels(people_counts_type),
// 				result: LabelHelper.people_labels(result),
// 				key: id
// 			});
// 		});
...
// 	render() {
// 		const { loading } = this.props.peopleCountListPageProps;
// 		return (
...
// export default PeopleCountListPage;
