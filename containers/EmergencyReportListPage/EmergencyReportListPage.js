...
// class EmergencyReportListPage extends Component {

// 	componentDidMount(){
// 		this.props.getEmergencyReportList();
// 	}
...
// 	renderTable() {
// 		const { emergency_reports } = this.props.emergencyReportListPageProps || {};
// 		let data = [];

// 		emergency_reports  && emergency_reports .length && emergency_reports .map( emergency_reports => {
// 			const { _id: id, user_id, location_id, door_id, time, emergency_type, result } = emergency_reports;
// 			data.push({
// 				id,
// 				name: user_id.name,
...
// 				emergency_type: LabelHelper.emergency_reports_labels(emergency_type),
// 				result: LabelHelper.emergency_reports_labels(result),
// 				key: id
// 			});
// 		});
...
// 	render() {
// 		const { loading } = this.props.emergencyReportListPageProps;
// 		return (
...
// export default EmergencyReportListPage;
